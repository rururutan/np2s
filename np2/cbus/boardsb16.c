...
static void IOOUTCALL sb16_o2100(UINT port, REG8 dat) {
	...
	S98_put(NORMAL2608, opl.addr, dat);
...
void boardsb16_bind(void) {
	...
	iocore_attachout(0x2000 + sb16.base, sb16_o2000);	/* FM Music Register Address Port */
	iocore_attachout(0x2100 + sb16.base, sb16_o2100);	/* FM Music Data Port */
	iocore_attachout(0x2200 + sb16.base, sb16_o2200);	/* Advanced FM Music Register Address Port */
	iocore_attachout(0x2300 + sb16.base, sb16_o2300);	/* Advanced FM Music Data Port */
	iocore_attachout(0x2800 + sb16.base, sb16_o2800);	/* FM Music Register Port */
	iocore_attachout(0x2900 + sb16.base, sb16_o2900);	/* FM Music Data Port */

	iocore_attachinp(0x2000 + sb16.base, sb16_i2000);	/* FM Music Status Port */
	iocore_attachinp(0x2200 + sb16.base, sb16_i2200);	/* Advanced FM Music Status Port */
	iocore_attachinp(0x2800 + sb16.base, sb16_i2800);	/* FM Music Status Port */

	iocore_attachout(0x0400 + sb16.base, sb16_o0400);	/* GAME Port */
	iocore_attachout(0x0500 + sb16.base, sb16_o0500);	/* GAME Port */
	iocore_attachout(0x0600 + sb16.base, sb16_o0600);	/* GAME Port */
	iocore_attachout(0x0700 + sb16.base, sb16_o0700);	/* GAME Port */
	iocore_attachinp(0x0400 + sb16.base, sb16_i0400);	/* GAME Port */
	iocore_attachinp(0x0500 + sb16.base, sb16_i0500);	/* GAME Port */
	iocore_attachinp(0x0600 + sb16.base, sb16_i0600);	/* GAME Port */
	iocore_attachinp(0x0700 + sb16.base, sb16_i0700);	/* GAME Port */

	iocore_attachout(0x8000 + sb16.base, sb16_o8000);	/* MIDI Port */
	iocore_attachout(0x8100 + sb16.base, sb16_o8100);	/* MIDI Port */
	iocore_attachinp(0x8000 + sb16.base, sb16_i8000);	/* MIDI Port */
	iocore_attachinp(0x8100 + sb16.base, sb16_i8100);	/* MIDI Port */
